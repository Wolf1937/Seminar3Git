...
![Картинка](https://proprikol.ru/wp-content/uploads/2020/04/krasivye-kartinki-vysokogo-razresheniya-3.jpg)
...
Работа с **цитататми** выполняется через знак ">":
...
![Картинка](https://i.stack.imgur.com/3p4Lx.png)
...
Git - это одна из реализаций распределённых систем контроля версий, имеющая как и локальные, так и удалённые репозитории. Является самой популярной реализацией систем контроля версий в мире.
![Картинка](https://fuzeservers.ru/wp-content/uploads/3/d/0/3d04c77fc4b28183e47e091b125bf1a1.png)
...
## ПАМЯТКА С КОНСОЛЬНЫМИ КОМАНДАМИ
[Смотри тут](https://github.com/cyberspacedk/Git-commands)
